...
public class TextDrawable extends ShapeDrawable {
    ...
    private void drawVectorImage(Canvas canvas) {
        ...
        Bitmap bitmap = new DrawableToBitmap().getBitmapFromVectorDrawable(context, drawableRes, width, height);
    ...
    public static class Builder implements IConfigBuilder, IShapeBuilder, IBuilder {
        ...
        @Override
        public TextDrawable buildTextVectorImage(Context context, String text, int drawableId, int width, int height) {
            this.text = text;
            this.color = Color.TRANSPARENT;
            this.context = context;
            this.drawableRes = drawableId;
            this.width = width;
            this.height = height;
    ...
    public static interface IShapeBuilder {
        ...
        public TextDrawable buildTextVectorImage(Context context, String text, @DrawableRes int drawableId, int width, int height);
